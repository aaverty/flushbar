...
//     _focusAttachment.detach();
  ...
  Widget _buildProgressIndicator() {
    if (widget.showProgressIndicator && _progressAnimation != null) {
      return AnimatedBuilder(
        ...
        builder: (_, __) {
          return widget.showProgressIndicator && _progressAnimation.value.floor() < 1
  ...
  Widget _getTitleText() {
    // widget.title = widget.progressIndicatorController.value.floor() >= 1 ? 'Montage de votre CV vidéo en cours' : 'Envoi de vos vidéos au serveur';
